...
public class CamRobotPersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "CamRobot";
	...
	private CamRobotPersistentManager() throws PersistentException {
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new CamRobotPersistentManager();
		}
